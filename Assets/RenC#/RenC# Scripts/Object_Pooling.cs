...
{
    /// <summary>
    /// class for mass-spawned objects that you don't need to keep specific track of.
    /// </summary>
    public static class Object_Pooling
    {
        ...
        public static async Awaitable DespawnOverTimeAsync(GameObject obj, float timeToDespawn, bool b = false)
        {
            float t = 0;
            while(obj != null && t <= timeToDespawn && obj.activeInHierarchy)
            {
